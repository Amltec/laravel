...
@include('templates.components.tree',[
    ...
    'sub'=>[
            ...
            'g'=>array('title'=>'Opção G - cor','icon'=>'fa-user','class'=>'bg-aqua'),
...
<a href="#" onclick="if($('#tree01').addClass('tree-condensed'))return false;">Condensar: on</a> |
<a href="#" onclick="if($('#tree01').removeClass('tree-condensed'))return false;">Condensar: off</a> |
<a href="#" onclick="if($('#tree01').addClass('tree-bordered'))return false;">Borda: on</a> |
<a href="#" onclick="if($('#tree01').removeClass('tree-bordered'))return false;">Borda: off</a> |
<a href="#" onclick="if($('#tree01').addClass('tree-hover'))return false;">Hover: on</a> |
<a href="#" onclick="if($('#tree01').removeClass('tree-hover'))return false;">Hover: off</a> |
