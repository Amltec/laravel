...
<div class="box-body">
    ...
    @include('templates.components.button',['title'=> 'Abrir Arquivos','color'=>'primary', 'icon'=>'fa-image','onclick'=>'awFilemanager({controller:"files",multiple:true,onSelectFile:function(opt){ alert(awCount(opt.files)+" arquivos selecionados") }  });'])
