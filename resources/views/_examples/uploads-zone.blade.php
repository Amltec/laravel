...
@include('templates.ui.auto_fields',[
    ...
    'autocolumns'=>[
        ...
        //'data-opt'=>['type'=>'hidden','value'=>json_encode(['private'=>true])],
    ...
    $('#botao04').on('click',function(){
        if(oUplModal){
            ...
            oUplModal=awModal({
                ...
                form:'method="POST" action="<?=route('super-admin.file.post','files')?>" accept-charset="UTF-8" enctype="multipart/form-data" id="form-filezone04"',
                form_opt:{
                    btAutoUpload:'[name=file]',
