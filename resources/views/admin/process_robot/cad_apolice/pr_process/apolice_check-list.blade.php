...
@section('title')
Verificação de Dados do Cadastros de Apólice
@endsection


@section('toolbar-header')
    <a href="#" class="btn btn-primary" id="bt-add-process">Adicionar Verificação Manual</a>
@endsection
...
<script>
    var bt=$('#bt-add-process').on('click',function(){
        awModal({
            title:'Adicionando apólices para verificação manual',
            html:function(oHtml){
                oHtml.html(
