...
@can('admin')
<a href="#" class="btn btn-primary" id="bt-add-process">Adicionar Busca de Boletos</a>
@endcan
@endsection
...
<script>
    var bt=$('#bt-add-process').on('click',function(){
        awModal({
            title:'Adicionando apólices para busca de boletos nos sites das seguradoras',
            html:function(oHtml){
                oHtml.html(
            ...
            form_opt:{
                dataFields:{process_prod:'boleto_seg'},
