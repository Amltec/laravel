...
@section('toolbar-header')
    @include('templates.components.button',['title'=> '+ Usuário','color'=>'primary','href'=>route('admin.app.get',['users','create'])])
@endsection
...
@include('templates.ui.auto_list',[
    ...
    'routes'=>[
        'click'=>function($reg){return route('admin.app.edit',['users',$reg->id]);},
        'remove'=>route('admin.app.remove','users'),
    ],
