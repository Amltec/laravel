 ...
 */
class mitsuiClass extends ProcessResidencialClass{
    use mitsuiInsurer;
    ...
    private function processTipo01(){
        ...
        //dd($data);
         ...
         $blocktext = TextUtility::getPartOfStr($this->text_ws02, ['start'=>'Local do Risco','sanitize'=>false]);
         $blocktext = TextUtility::getPartOfStr($blocktext, ['end'=>'Tipo de']);
        ...
        //dd($blocktext);
         ...
         //dd($bairro,$cidade,$estado,$blocktext,$this->text);
