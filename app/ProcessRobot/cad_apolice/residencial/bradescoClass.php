 ...
 */
class bradescoClass extends ProcessResidencialClass{
    use bradescoInsurer;
    ...
    */
    private function processTipo01(){
        ...
        if($cidade=='Cidade'){
            $cidade = $this->getX1(['start'=>'Cidade','return_type'=>'prev'],$blocktext);
            $numero = $this->getX1(['start'=>'Complemento','return_type'=>'next'],$blocktext);
            $complemento = $this->getX1(['start'=>'Bairro','return_type'=>'prev'],$blocktext);
            //dd($cidade,$blocktext);
        }
        ...
        $data['residencial_bairro_1'] = $bairro;
        $data['residencial_cidade_1'] = $cidade;
        $data['residencial_uf_1'] = $estado ;
