...
class ProdBoletoSeg{
    ...
    public function wsrobot_data_set_process($params, $thisClass){
         ...
         * 2) Procura o arquivo zip ($data['filename_tmp']) no diretório enviado por ftp, descompacta-o,
        ...
        //captura o caminho do ftp e nome do arquivo zip
            ...
            $path = $ProcessModel->getPaths();
            $filezip = $path['upload_robo']. DIRECTORY_SEPARATOR . $filename_tmp;
        ...
        foreach($data_robot as $process_id=>$data_item){
            ...
            if($code=='ok'){//tem boletos para baixar
                ...
                //deleta a pasta de origem dentro de seguradora_data/boleto_seg
